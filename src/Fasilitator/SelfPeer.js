...
const SelfPeer = () => {
  ...
  const [selfProgress, setSelfProgress] = useState(20);
  const [peerProgress, setPeerProgress] = useState(30);
            ...
            <div className="selfpeer-item-fs">
              <div className="description-fs">
                <div className="selfpeer-text-fs">
                  ...
                  <div className="selfpeer-batch-fs">{selfpeer.no}</div>
                </div>
              </div>

              <div className="fs-Button">                             
                <div className="peer-button-fs">
